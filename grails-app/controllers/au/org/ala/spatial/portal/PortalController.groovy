...
//    @ApiImplicitParams([])
    ...
    def speciesList() {
        ...
        if (!userId) {
            ...
            def r = webService.get("${url}/ws/speciesList", [user: userId, max: params.max, offset: params.offset ?: 0, max: params.max ?: 100, q: params.q ?: '', sort: params.sort ?: '', order: params.order ?: 'asc'], org.apache.http.entity.ContentType.APPLICATION_JSON, false, true, [:])
